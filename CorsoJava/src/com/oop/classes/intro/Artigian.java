...
public class Artigian {
    ...
    public Artigian(int redditoAnnoLordo, int coefficenteDiRedditiva, int tassaIrpef, int tassaInps,
    ...
    public static void main(String[] args) {
        ...
        Artigian artigian = new Artigian(
                90000, 
                67,
                15,
                3500,
        ...
        System.out.println(artigian.getUtile());
        System.out.println(artigian.getCifraInps());
        System.out.println(artigian.getCifraIrpef());
        System.out.println(artigian.getUtileEccedente());
        System.out.println(artigian.getRedditoNetto());
